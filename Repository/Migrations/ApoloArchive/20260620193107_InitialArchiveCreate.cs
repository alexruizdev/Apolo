...
namespace Repository.Migrations.ApoloArchive
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Specification_Service_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Specification_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Specification_ServiceId",
                table: "Specification",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_Specification_StudentId",
                table: "Specification",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Students_PayerId",
                table: "Students",
                column: "PayerId");
        }
